...
namespace Notenmanager
{
    public partial class Notenmanager2 : ContentPage
    {
        ...
        private async void OnNavigate2(object sender, EventArgs e)
        {
            await Shell.Current.GoToAsync("//Notenmanager3");
        }
    }
}